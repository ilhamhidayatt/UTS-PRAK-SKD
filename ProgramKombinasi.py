...
def main():
    ...
    pesanDekripsi= "MTJWQSCQFNFNYWHZSZMIVCEEZMGCNEHNMLSBVSKBXQITYUSEDWPOENBBODABMTMWHNKM"

    kunci = 'UZHUMAKINARUTO'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'MTJWQSCQFNFNYWHZSZMIVCEEZMGCNEHNMLSBVSKBXQITYUSEDWPOENBBODABMTMWHNKM'
    ...
    print('Ciphertext : KHPCMASMNRNRQCBXAXKIVSGGXKUSRGBRKDALVAWLJMIHQOAGZCFYGRLLYZELKHKCBRWK')
